            ...
            <section id="dashboard">
                ...
                <div id="status">
                    ...
                    <div id="Bus" class="info-box status-item">
                        <div class="heading">
                            <h5><i class="fas fa-bus"></i><br>Buses</h5>
                            <div class="info">
                            </div>
                        </div>
                        <div class="info-content">
                    ...
                    <div id="Route" class="info-box status-item">
                        <div class="heading">
                            <h5><i class="fas fa-road"></i><br>Routes</h5>
                            <div class="info">
                            </div>
                        </div>
                        <div class="info-content">
                    ...
                    <div id="Seat" class="info-box status-item">
                        <div class="heading">
                            <h5><i class="fas fa-th"></i><br>Seats</h5>
                            <div class="info">
                            </div>
                        </div>
                        <div class="info-content">
                ...
                <div id="user">
                    <div id="Customer" class="info-box user-item">
                        <div class="heading">
                            <h5> <i class="fas fa-users"></i><br>Customers</h5>
                            <div class="info">
                            </div>
                        </div>
                        <div class="info-content">
                    ...
                    <div id="Admin" class="info-box user-item">
                        <div class="heading">
                            <h5><i class="fas fa-user-lock"></i><br>Admins</h5>
                            <div class="info">
                            </div>
                        </div>
                        <div class="info-content">
                    ...
                    <div id="Earning" class="info-box user-item">
                        <div class="heading">
                            <h5><i class="fas fa-dollar-sign"></i><br>Earnings</h5>
                            <div class="info">
                            </div>
                        </div>
                        <div class="info-content">
                ...
                <h4 style="margin-left:20px;">Other Admin</h4>
                <div id="admin">
                    <?php 
                ...
                <footer>
                    <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Interpure Sdn.Bhd | Made with &#10084;&#65039;
                        </p>
                </footer>
        </div>
    </main>
